...
CREATE TABLE "application" (
	...
	"weight_cargo_kg" numeric NOT NULL,
	"length_cargo_m" numeric NOT NULL,
	"width_cargo_m" numeric NOT NULL,
	"heigth_cargo_m" numeric NOT NULL,
...
CREATE TABLE "car" (
	...
	"capacity_carrying_kg" numeric NOT NULL,
	"length_dimensions_m" numeric NOT NULL,
	"width_dimensions_m" numeric NOT NULL,
	"heigth_dimensions_m" numeric NOT NULL,
...
ALTER TABLE "registration_data" ADD CONSTRAINT "registration_data_fk0" FOREIGN KEY ("role_id") REFERENCES "role"("id");
